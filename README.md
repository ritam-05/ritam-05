...
- **[GitaWise](https://github.com/ritam-05/gita-wise-rag)** — RAG-based AI application on gita verses
...
- **[VoiceGuard](https://github.com/ritam-05/voice-detector-api)** — Human vs AI Voice detection
